...
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
    ...
    <style type="text/css">
        * {
        ...
        .ddlMotherboard, .ddlPowerUnit, .ddlGraphicsCard, .ddlRAM, .ddlHardDrive {
            margin-top: 20px;
            padding: 10px;
            margin-left: 40%;
        }
                        ...
                        <div class="col-md-12" id="control-container">
                            ...
                            <div class="col-md-4">
                                <div class="box hovereffect" id="graphic-cards">
                                    <div class="overlay">
                                        <h3 class="info"><a id="animateGraphics" href="#modalGraphics">Buy Now</a></h3>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="box hovereffect" id="hard-drives">
                                    <div class="overlay">
                                        <h3 class="info"><a id="animateHDD" href="#modalHDD">Buy Now</a></h3>
                                    </div>
